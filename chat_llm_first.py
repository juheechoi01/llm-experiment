#!/usr/bin/env python3
"""GPT-4o terminal chat where the LLM speaks first."""
...
DEFAULT_SYSTEM_PROMPT = "You are a helpful assistant. Always respond in Korean."
...
def chat(system_prompt: str):
    ...
    while True:
        ...
        try:
            assistant_msg = get_response(client, history)
